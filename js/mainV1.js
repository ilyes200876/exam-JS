...
function genererVignette(image, nom, categorie, prix){
  elements.forEach(function(element, i){
    ...
    elementFigure.className = "vignette";
...
window.addEventListener("load", function(){
  ...
  zone1.style.backgroundSize = "cover";
  zone1.innerHTML = `<div id="description"><div><h1>Nom</h1><p>animal1</p></div><div><h1>Catégorie</h1><p>aAnimaux</p></div><div><h1>Prix</h1><p>200€</p></div></div>`;
      let description = document.querySelector("#description");
      description.style.color = "white";
      description.style.backgroundColor = "black";
      description.style.opacity = "0.7";
